...
type
  TfmSetup = class(TTntForm)
    ...
    ecHotKey: TecHotKey;
    bKeySet: TSpTBXButton;
    bKeyClr: TSpTBXButton;
    tabFiles: TTntTabSheet;
    gEdit: TSpTBXGroupBox;
    cbBOver: TSpTBXCheckBox;
    cbBPers: TSpTBXCheckBox;
    cbDClick: TSpTBXCheckBox;
    cbGrSel: TSpTBXCheckBox;
    cbWrap: TSpTBXCheckBox;
    cbFold: TSpTBXCheckBox;
    cbDrag: TSpTBXCheckBox;
    cbCollap: TSpTBXCheckBox;
    cbFLine: TSpTBXCheckBox;
    Bevel1: TBevel;
    cbAutoInd: TSpTBXCheckBox;
    cbBackInd: TSpTBXCheckBox;
    cbGrRedo: TSpTBXCheckBox;
    cbGrUndo: TSpTBXCheckBox;
    cbUndoSav: TSpTBXCheckBox;
    cbCopyRtf: TSpTBXCheckBox;
    cbSmCaret: TSpTBXCheckBox;
    cbKeepCaret: TSpTBXCheckBox;
    cbOptFill: TSpTBXCheckBox;
    cbColSel: TSpTBXCheckBox;
    cbFloatM: TSpTBXCheckBox;
    cbScrollLast: TSpTBXCheckBox;
    cbWrapMar: TSpTBXCheckBox;
    cbFixMove: TSpTBXCheckBox;
    cbVarHorz: TSpTBXCheckBox;
    cbUnindKeep: TSpTBXCheckBox;
    cbKeepBlank: TSpTBXCheckBox;
    gColors: TSpTBXGroupBox;
    Label4: TSpTBXLabel;
    ListColors: TSpTBXListBox;
    Label5: TSpTBXLabel;
    StaticText1: TTntStaticText;
    tabIntf: TTntTabSheet;
    boxIntf: TSpTBXGroupBox;
    cbChar: TSpTBXCheckBox;
    Label11: TSpTBXLabel;
    cbStat: TSpTBXCheckBox;
    tabACP: TTntTabSheet;
    tabEd2: TTntTabSheet;
    gEditor: TSpTBXGroupBox;
    Label15: TSpTBXLabel;
    Label3: TSpTBXLabel;
    Label14: TSpTBXLabel;
    cbDSep: TSpTBXCheckBox;
    cbDGrad: TSpTBXCheckBox;
    cbLink: TSpTBXCheckBox;
    cbDLBack: TSpTBXCheckBox;
    cbCaret: TSpTBXCheckBox;
    cbHideCur: TSpTBXCheckBox;
    cbHideD: TSpTBXCheckBox;
    cbHideSel: TSpTBXCheckBox;
    edLSpace: TSpinEdit;
    edMar: TSpinEdit;
    cbMar: TSpTBXCheckBox;
    edNums: TSpTBXComboBox;
    ...
    edTab_: TSpTBXEdit;
    Label16: TSpTBXLabel;
    cbDFocus: TSpTBXCheckBox;
    cbRuler: TSpTBXCheckBox;
    bKeyFn: TSpTBXButton;
    cbMenu: TSpTBXCheckBox;
    Label18: TSpTBXLabel;
    cbLang: TSpTBXComboBox;
    DKLanguageController1: TDKLanguageController;
    ColorBox1: TColorBox;
    cbKeepScr: TSpTBXCheckBox;
    cbInst: TSpTBXCheckBox;
    gAcpAll: TSpTBXGroupBox;
    Label42: TSpTBXLabel;
    cbAcpFilter: TSpTBXComboBox;
    cbAcpNone: TSpTBXCheckBox;
    cbTabSp: TSpTBXCheckBox;
    boxNew: TSpTBXGroupBox;
    TntLabel4: TSpTBXLabel;
    edEnc: TSpTBXComboBox;
    TntLabel5: TSpTBXLabel;
    edLE: TSpTBXComboBox;
    TntLabel6: TSpTBXLabel;
    edLex: TSpTBXComboBox;
    cbSmHi: TSpTBXCheckBox;
    edAcpDrop: TSpinEdit;
    bColorLoad: TSpTBXButton;
    bColorSave: TSpTBXButton;
    OpenDialogPre: TOpenDialog;
    SaveDialogPre: TSaveDialog;
    cbBrHi: TSpTBXCheckBox;
    tabHist: TTntTabSheet;
    boxHist: TSpTBXGroupBox;
    Label8: TSpTBXLabel;
    Label7: TSpTBXLabel;
    TntLabel11: TSpTBXLabel;
    edFS: TSpinEdit;
    edSR: TSpinEdit;
    cbHCaret: TSpTBXCheckBox;
    cbHEnc: TSpTBXCheckBox;
    bClrSR: TSpTBXButton;
    bClrFS: TSpTBXButton;
    cbMru: TSpTBXCheckBox;
    cbDirLast: TSpTBXComboBox;
    edDirLast: TSpTBXEdit;
    bDirLast: TSpTBXButton;
    cbSmHiCase: TSpTBXCheckBox;
    cbFixBlocks: TSpTBXCheckBox;
    TntLabel10: TSpTBXLabel;
    cbBak: TSpTBXComboBox;
    edAcpNum: TSpinEdit;
    gAcp2: TSpTBXGroupBox;
    cbAcpFile: TSpTBXCheckBox;
    edAcpFileChars: TSpinEdit;
    edAcpFileSize: TSpinEdit;
    LabelAcpFileChars: TSpTBXLabel;
    LabelAcpFileSize: TSpTBXLabel;
    cbKeyCat: TSpTBXComboBox;
    TntLabel19: TSpTBXLabel;
    cbShowEOL: TSpTBXCheckBox;
    cbEsc: TSpTBXComboBox;
    TntLabel21: TSpTBXLabel;
    tabSearch: TTntTabSheet;
    gSR: TSpTBXGroupBox;
    cbSrDlg: TSpTBXCheckBox;
    cbSrWord: TSpTBXCheckBox;
    cbSrHistTC: TSpTBXCheckBox;
    cbSrOnTop: TSpTBXCheckBox;
    gQSr: TSpTBXGroupBox;
    TntLabel2: TSpTBXLabel;
    cbQsEsc: TSpTBXComboBox;
    cbQsCap: TSpTBXCheckBox;
    TntLabel22: TSpTBXLabel;
    cbSrErr: TSpTBXCheckBox;
    cbSrErr2: TSpTBXCheckBox;
    cbBkUndo: TSpTBXCheckBox;
    edFilter: TSpTBXEdit;
    TntLabel25: TSpTBXLabel;
    TimerFilt: TTimer;
    cbStaples: TComboBox;
    TntLabel28: TSpTBXLabel;
    edStapleOffset: TSpinEdit;
    bFiltClear: TSpTBXButton;
    cbSrSel: TSpTBXCheckBox;
    tabASave: TTntTabSheet;
    gASave: TSpTBXGroupBox;
    cbASaveTimer: TSpTBXCheckBox;
    edASaveTime: TSpinEdit;
    cbASaveFocus: TSpTBXCheckBox;
    gASaveWhat: TSpTBXGroupBox;
    cbASaveCurrFile: TSpTBXRadioButton;
    cbASaveAllFiles: TSpTBXRadioButton;
    labASavIgnore: TSpTBXLabel;
    edASaveMaxSize: TSpinEdit;
    labASaveTime: TSpTBXLabel;
    labKByte: TSpTBXLabel;
    gUnnamed: TSpTBXGroupBox;
    edASaveUnnamedDir: TEdit;
    cbASaveUnIgnore: TSpTBXRadioButton;
    cbASaveUnShowSave: TSpTBXRadioButton;
    cbASaveUnSaveToDir: TSpTBXRadioButton;
    bUnnamedBrowse: TSpTBXButton;
    cbSrExpand: TSpTBXCheckBox;
    gAcpSp: TSpTBXGroupBox;
    cbAcpHtm: TSpTBXCheckBox;
    cbAcpTabbing: TSpTBXCheckBox;
    cbAcpCss: TSpTBXCheckBox;
    labSmTabHelp: TSpTBXLabel;
    cbHTemp: TSpTBXCheckBox;
    cbAcpUseSingle: TSpTBXCheckBox;
    cbRoStart: TSpTBXCheckBox;
    cbTplTabbing: TSpTBXCheckBox;
    labTplHelp: TSpTBXLabel;
    cbACloseTags: TSpTBXCheckBox;
    TntLabel7: TSpTBXLabel;
    TntLabel12: TSpTBXLabel;
    labAutoCloseHelp: TSpTBXLabel;
    cbACloseBr: TSpTBXCheckBox;
    cbACloseBrEsc: TSpTBXCheckBox;
    cbACloseQ: TSpTBXCheckBox;
    cbDWrapMark: TSpTBXCheckBox;
    ListCat: TSpTBXListBox;
    tabTabs: TTntTabSheet;
    boxTabs: TSpTBXGroupBox;
    TntLabel3: TSpTBXLabel;
    cbTabBtn: TSpTBXCheckBox;
    cbTabMul: TSpTBXCheckBox;
    cbTabDown: TSpTBXCheckBox;
    cbTabNums: TSpTBXCheckBox;
    cbTabSw: TSpTBXCheckBox;
    cbTabDnD: TSpTBXCheckBox;
    edTabMaxLen: TSpinEdit;
    cbTabDbl: TSpTBXCheckBox;
    boxToolbar: TSpTBXGroupBox;
    Label2: TSpTBXLabel;
    cbTheme: TSpTBXComboBox;
    Label12: TSpTBXLabel;
    cbIcons: TSpTBXComboBox;
    tabFonts: TTntTabSheet;
    gFont: TSpTBXGroupBox;
    b1: TSpTBXButton;
    b2: TSpTBXButton;
    b4: TSpTBXButton;
    b3: TSpTBXButton;
    ...
    gTree: TSpTBXGroupBox;
    TntLabel17: TSpTBXLabel;
    cbTreeSync: TSpTBXCheckBox;
    cbTreeCollapse: TSpTBXCheckBox;
    cbTreeExpand: TSpTBXCheckBox;
    cbTreeSort: TSpTBXCheckBox;
    cbTreeTrack: TSpTBXCheckBox;
    cbTreeAction: TSpTBXComboBox;
    tabSess: TTntTabSheet;
    boxSess: TSpTBXGroupBox;
    cbSessDef: TSpTBXCheckBox;
    cbSessLoad: TSpTBXCheckBox;
    cbSessSave: TSpTBXCheckBox;
    boxProj: TSpTBXGroupBox;
    cbProjLoad: TSpTBXCheckBox;
    cbProjSave: TSpTBXCheckBox;
    TntGroupBox1: TSpTBXGroupBox;
    TntLabel26: TSpTBXLabel;
    cbMapHScroll: TSpTBXCheckBox;
    cbMapVScroll: TSpTBXCheckBox;
    edMapZoom: TSpinEdit;
    boxFGroup: TSpTBXGroupBox;
    TntLabel1: TSpTBXLabel;
    cbText_: TSpTBXComboBox;
    Label17: TSpTBXLabel;
    TntLabel8: TSpTBXLabel;
    edOem: TSpTBXEdit;
    edUTF8: TSpTBXEdit;
    TntLabel9: TSpTBXLabel;
    boxReload: TSpTBXGroupBox;
    Label9: TSpTBXLabel;
    cbNotif: TSpTBXComboBox;
    cbTail: TSpTBXCheckBox;
    cbOverRO: TSpTBXCheckBox;
    edBigSize: TSpinEdit;
    TntLabel23: TSpTBXLabel;
    tabMisc: TTntTabSheet;
    boxMisc: TSpTBXGroupBox;
    labDate: TSpTBXLabel;
    TntLabel20: TSpTBXLabel;
    cbFullTitle: TSpTBXCheckBox;
    cbGroupLexers: TSpTBXCheckBox;
    cbMenuIcon: TSpTBXCheckBox;
    edDateFmt: TSpTBXEdit;
    cbBeep: TSpTBXCheckBox;
    cbTips: TSpTBXCheckBox;
    edMovX: TSpinEdit;
    edMovY: TSpinEdit;
    cbZenProfile: TSpTBXComboBox;
    ListTabColors: TSpTBXListBox;
    TntLabel13: TSpTBXLabel;
    cbStripBk: TSpTBXCheckBox;
    tabFolders: TTntTabSheet;
    boxFolders: TSpTBXGroupBox;
    TntLabel14: TSpTBXLabel;
    TntLabel15: TSpTBXLabel;
    edFolders: TTntMemo;
    bAddFolder: TSpTBXButton;
    tabSpell: TTntTabSheet;
    boxSpellOpt: TSpTBXGroupBox;
    TntLabel16: TSpTBXLabel;
    TntLabel24: TSpTBXLabel;
    edSpellExt: TSpTBXEdit;
    cbSpellEn: TSpTBXCheckBox;
    bSpellOpt: TSpTBXButton;
    boxSpellLnk: TSpTBXGroupBox;
    TntLabel27: TSpTBXLabel;
    labDictWww: TSpTBXLabel;
    labDictDir: TSpTBXLabel;
    cbSavePos: TSpTBXCheckBox;
    tabOvr: TTntTabSheet;
    TntLabel18: TSpTBXLabel;
    edSrOffsetY: TSpinEdit;
    TntLabel32: TSpTBXLabel;
    edDateFmtP: TSpTBXEdit;
    TntLabel33: TSpTBXLabel;
    cbColorOnEmpty: TSpTBXCheckBox;
    cbTabVis: TSpTBXComboBox;
    edTplTabEx: TEdit;
    TntLabel34: TSpTBXLabel;
    Bevel2: TBevel;
    cbSelMode: TSpTBXComboBox;
    TntLabel35: TSpTBXLabel;
    cbKeepPaste: TSpTBXCheckBox;
    TntLabel36: TSpTBXLabel;
    cbUniNeed: TSpTBXComboBox;
    cbRecColors: TSpTBXComboBox;
    TntLabel37: TSpTBXLabel;
    cbCopyLineNSel: TSpTBXCheckBox;
    cbMicroMap: TSpTBXCheckBox;
    cbSortMode: TSpTBXComboBox;
    TntLabel38: TSpTBXLabel;
    labEmmet: TSpTBXLabel;
    cbTreeDelay: TSpinEdit;
    TntLabel39: TSpTBXLabel;
    TntLabel29: TSpTBXLabel;
    cbUrlClick: TSpTBXCheckBox;
